...
def myModel():
    model = Sequential()
    model.add(Input(shape=(imageDimesions[0], imageDimesions[1], 1)))  # add explicit Input layer here
    model.add(Conv2D(60, (5,5), activation='relu'))  # remove input_shape here
